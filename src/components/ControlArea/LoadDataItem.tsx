            ...
            <div className="flex flex-row items-center justify-between gap-1">
                <div>
                    <button
                        ...
                        className="flex justify-center items-center px-1 h-7 w-7">
                ...
                <div className="text-left w-[50%]">{dataItem.rosterName}</div>

                <div className="flex flex-row">
                    <button
                        onClick={handleClickDelete}
                        className={`flex justify-center items-center rounded-md  px-1 h-7 w-7 ${deleteConfirm ? 'bg-red-400' : 'text-white' }`}>
