            ...
            <div className="flex flex-row items-center justify-between gap-1 mb-1">
                <div className="flex flex-row justify-start gap-1">
                    <div className="rounded-md mr-1 flex justify-center items-center">
                        <button
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="text-blue-500 size-6 hover:text-orange-400">
                    ...
                    <div
                        onClick={handleClickLoad} 
                        className="w-[80px] text-left hover:cursor-pointer">
                        <div
                    ...
                    <div 
                        onClick={handleClickLoad} 
                        className="text-left text-sm w-[100px] text-wrap hover:cursor-pointer">
                        {dataItem.rosterName}
                    </div>
                </div>
                <div className={`flex flex-row w-[70px] ${deleteConfirm ? 'justify-between': 'justify-end'}`}>
                    <button
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={` size-6 ${deleteConfirm ? 'text-white' : 'text-red-400 hover:text-red-700' }`}>
