        ...
        <>
            {showAbout &&
                <div 
                    ...
                    onClick={closeAbout}
                    >
                    <div className="rounded-lg p-2 text-black w-[320px] h-[300px] z-60 bg-white/100 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 shadow-2xl">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-left">This dragonboat calculator is a simple proof-of-concept web app that loads paddler information, and helps to see weight distribution on the dragon boat.</p>
